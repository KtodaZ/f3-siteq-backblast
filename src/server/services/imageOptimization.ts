 ...
 */
export function validateImage(buffer: Buffer, maxSizeBytes: number = 10 * 1024 * 1024): Promise<boolean> {
 ...
 */
export async function extractDominantColors(buffer: Buffer, count: number = 3): Promise<string[]> {
  try {
